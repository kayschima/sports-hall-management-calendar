...
class TrainingTimesComponent extends Component
{
    ...
    public function toggleParticipation($trainingtime_id, $user_id)
    {
        TrainingTime::find($trainingtime_id)->users()->toggle([$user_id]);
    }
    ...
    public function render()
    {
        ...
        $trainingstimes = $trainingstimes->withCount('users')
                                         ->with('users')
                                         ->orderBy('date')
                                         ->orderBy('time')
                                         ->get();
